document.addEventListener('DOMContentLoaded', function() {
    // By default, load all
    load_all();
    document.querySelector('#following_block').style = 'font-weight: bold; background-image: linear-gradient(to left, teal, grey);'
    document.querySelector('#following_link').style = 'color:white; font-weight: bold;'
    // Comment click
